    ...
    const onSubmit = async (data) => {
        ...
        if (result.status){
            ...
            const datosMail = {
                ...
                http://localhost:5173/service/${result.tokenLink}`,
           ...
           <p><a href="http://localhost:5173/service/${result.tokenLink}" style="background-color: blue; color: white; padding: 10px 20px; text-decoration: none;">Completar formulario de reclamo</a></p>`,
