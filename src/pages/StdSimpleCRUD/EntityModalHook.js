...
export const useEntityModal = () => {
    ...
    const [isEntityUpdated, setIsEntityUpdated] = useState(true);
    ...
    return { isModalOpen, modalClose, entityModalOnSave, handleRowUpdate, updatedInfo, isEntityUpdated, setIsEntityUpdated };
};